      ...
      <Grid container spacing={5}>
        <Grid item sm={4}>
          <Box className={classes.expTile}>
            ...
            <Typography className={classes.expDate} variant='body2'>May 2017 - June 2018</Typography>
          </Box>
        </Grid>
        <Grid item sm={8}>
          <Box>
            <Typography className={classes.eduTitle} variant='h6'>Research Assistant</Typography>
